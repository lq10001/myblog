...
if __name__ == '__main__':
	...
	commands = [
	["git submodule add --force git@git.oschina.net:dongfangx/nutz-sys.git src/main/java/com/ly/sys", 'v2.2'],
	["git submodule add --force git@git.oschina.net:dongfangx/beetl-bjui-sys.git src/main/webapp/WEB-INF/sys", 'v1.5'],
	["git submodule add --force git@git.oschina.net:dongfangx/nutz-common.git src/main/java/com/ly/comm", 'v1.4'],
	["git submodule add --force git@git.oschina.net:dongfangx/sys-resources.git src/main/webapp/sys", 'v1.4'],
